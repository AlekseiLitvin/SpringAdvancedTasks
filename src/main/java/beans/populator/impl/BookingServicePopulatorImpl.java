...
@Component("bookingServicePopulator")
public class BookingServicePopulatorImpl implements BookingServicePopulator {

    public static boolean isDatabasePopulated = false;
